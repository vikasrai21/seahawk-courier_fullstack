import{l as Et,_ as Ze}from"./index-B2TGPPpL.js";import{j as e}from"./page-landing-Bx5c8M2c.js";import{r as s}from"./vendor-helmet-Dwc3L0SQ.js";import{c as It,u as Rt}from"./vendor-react-DGJm5saH.js";import{b as et,R as be,aD as tt,V as At,aE as nt,aF as it,aG as zt,a5 as Tt,d as st,a0 as Bt,z as ot,aH as rt,aI as Ot,aJ as Mt,au as Pt,aK as Dt,aL as at,O as $t,ax as Wt,X as _t}from"./vendor-icons-CFYsIw6f.js";import"./page-import-BSgSX41f.js";import"./page-reconcile-DVSj51Qh.js";import"./page-rate-calc-Co4B1nq2.js";const Lt=window.location.origin,ct={w:"90vw",h:"18vw"},lt={w:"92vw",h:"130vw"},Gt=3500,qt="mobile_scanner_offline_queue",Ut=80,ye=["code_128","code_39","code_93","codabar","ean_13","ean_8","itf","qr_code"],o={IDLE:"IDLE",SCANNING:"SCANNING",CAPTURING:"CAPTURING",PREVIEW:"PREVIEW",PROCESSING:"PROCESSING",REVIEWING:"REVIEWING",APPROVING:"APPROVING",SUCCESS:"SUCCESS",ERROR:"ERROR"},q=a=>{var x;try{(x=navigator==null?void 0:navigator.vibrate)==null||x.call(navigator,a)}catch{}},ae=(a,x,D="sine")=>{try{const l=new(window.AudioContext||window.webkitAudioContext),$=l.createOscillator(),b=l.createGain();$.type=D,$.frequency.setValueAtTime(a,l.currentTime),b.gain.setValueAtTime(.12,l.currentTime),b.gain.exponentialRampToValueAtTime(.01,l.currentTime+x),$.connect(b),b.connect(l.destination),$.start(),$.stop(l.currentTime+x)}catch{}},ve=()=>{ae(880,.12),setTimeout(()=>ae(1100,.1),130)},dt=()=>ae(600,.08),we=()=>ae(200,.25,"sawtooth"),ut=a=>{try{if(!window.speechSynthesis)return;window.speechSynthesis.cancel();const x=new SpeechSynthesisUtterance(a);x.rate=1.2,x.pitch=1,x.lang="en-IN",window.speechSynthesis.speak(x)}catch{}},i={bg:"#FAFBFD",surface:"#FFFFFF",border:"rgba(0,0,0,0.06)",text:"#111827",muted:"#6B7280",mutedLight:"#9CA3AF",primary:"#4F46E5",primaryLight:"#EEF2FF",success:"#059669",successLight:"#ECFDF5",warning:"#D97706",warningLight:"#FFFBEB",error:"#DC2626",errorLight:"#FEF2F2"},Vt=`
