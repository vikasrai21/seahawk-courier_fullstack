import{l as tn,_ as xt}from"./index-D3s4DjBR.js";import{j as e}from"./page-landing-Bx5c8M2c.js";import{r as i}from"./vendor-helmet-Dwc3L0SQ.js";import{n as nn}from"./barcode-DjYGNBFy.js";import{c as sn,u as on}from"./vendor-react-DGJm5saH.js";import{b as bt,R as Oe,aL as yt,V as rn,aD as wt,aE as Ct,aF as an,a5 as cn,d as vt,a0 as ln,z as jt,aG as Nt,aJ as St,aH as dn,aI as un,au as pn,aK as kt,O as mn,ax as hn,X as gn}from"./vendor-icons-Bdqpyfv7.js";import"./page-import-CyeJoxHM.js";import"./page-reconcile-DF_UVosL.js";import"./page-rate-calc-DThUjZnZ.js";function Ft(c,p){var z,A;try{if(!c||!p)return null;const F=Number(c.videoWidth||0),h=Number(c.videoHeight||0);if(!F||!h)return null;const m=(z=c.getBoundingClientRect)==null?void 0:z.call(c),X=(A=p.getBoundingClientRect)==null?void 0:A.call(p);if(!m||!X)return null;const w=Number(m.width||0),T=Number(m.height||0);if(!w||!T)return null;const P=Math.max(w/F,T/h),g=F*P,f=h*P,me=(w-g)/2,j=(T-f)/2,Y=X.left-m.left,G=X.top-m.top,ee=X.right-m.left,$e=X.bottom-m.top,oe=(Y-me)/P,a=(G-j)/P,re=(ee-me)/P,l=($e-j)/P,N=(b,ge,ne)=>Math.max(ge,Math.min(ne,b)),C=N(Math.min(oe,re),0,F),L=N(Math.min(a,l),0,h),he=N(Math.max(oe,re),0,F),K=N(Math.max(a,l),0,h),ae=Math.max(0,he-C),te=Math.max(0,K-L);return!ae||!te?null:{x:C,y:L,w:ae,h:te}}catch{return null}}const fn=window.location.origin,Et={w:"90vw",h:"18vw"},ke={w:"92vw",h:"130vw"},xn=3500,bn="mobile_scanner_offline_queue",yn=80,It=3,De=["code_128","code_39","code_93","codabar","ean_13","ean_8","itf","qr_code"],wn=!0,o={IDLE:"IDLE",SCANNING:"SCANNING",CAPTURING:"CAPTURING",PREVIEW:"PREVIEW",PROCESSING:"PROCESSING",REVIEWING:"REVIEWING",APPROVING:"APPROVING",SUCCESS:"SUCCESS",ERROR:"ERROR"},Z=c=>{var p;try{(p=navigator==null?void 0:navigator.vibrate)==null||p.call(navigator,c)}catch{}},Fe=(c,p,z="sine")=>{try{const A=new(window.AudioContext||window.webkitAudioContext),F=A.createOscillator(),h=A.createGain();F.type=z,F.frequency.setValueAtTime(c,A.currentTime),h.gain.setValueAtTime(.12,A.currentTime),h.gain.exponentialRampToValueAtTime(.01,A.currentTime+p),F.connect(h),h.connect(A.destination),F.start(),F.stop(A.currentTime+p)}catch{}},Pe=()=>{Fe(880,.12),setTimeout(()=>Fe(1100,.1),130)},Rt=()=>Fe(600,.08),Le=()=>Fe(200,.25,"sawtooth"),At=c=>{try{if(!window.speechSynthesis)return;window.speechSynthesis.cancel();const p=new SpeechSynthesisUtterance(c);p.rate=1.2,p.pitch=1,p.lang="en-IN",window.speechSynthesis.speak(p)}catch{}},zt=()=>{var c;try{if(typeof window>"u")return!1;if(window.isSecureContext)return!0;const p=((c=window.location)==null?void 0:c.hostname)||"";return p==="localhost"||p==="127.0.0.1"}catch{return!1}},s={bg:"#FAFBFD",surface:"#FFFFFF",border:"rgba(0,0,0,0.06)",text:"#111827",muted:"#6B7280",mutedLight:"#9CA3AF",primary:"#4F46E5",primaryLight:"#EEF2FF",success:"#059669",successLight:"#ECFDF5",warning:"#D97706",warningLight:"#FFFBEB",error:"#DC2626",errorLight:"#FEF2F2"},Cn=`
